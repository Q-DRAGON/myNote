...
// HTML5 新增特性
// 移动页面开发
// 桌面程序开发（就是开发 Atom 编辑器的 electron，上课讲）
//
/*
...
audio 基本操作如下
let a = document.querySelector('#id-audio-player')
a.play()
a.pause()
a.autoplay
a.src
...
HTML5 提供了两种存储方法 localStorage 与 sessionStorage
...
- 检测布局视口(viewport)的特性，比如视口的宽高分辨率等
...
这样的效果就是原生代码(相对于 js 而言的官方开发语言)实现功能并且提供 js 函数
js 代码用别人提供的功能写逻辑
