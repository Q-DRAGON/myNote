...
module.exports = {
    ...
    mode: 'production',
    // 通过配置 devtool 的值来提升代码的可读性, 这里直接把值设置为 [inline-source-map]
    devtool: 'inline-source-map',
    devServer: {
        // contentBase 指定 webpack dev server 从哪个目录获取内容
        contentBase: path.join(__dirname, 'dist'),
        // 开启 open 参数后, webpack dev server 会自动打开浏览器
        open: true,
    },
    // 监听文件变动, 当文件修改后, 会自动 build
    // 现在使用 webpack-dev-server, 这个选项不需要开启
    // watch: true,
